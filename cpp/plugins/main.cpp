...
int main ( ) {
  ...
  boost::shared_ptr<Plugins::Interface> plug1 = boost::dll::import<Plugins::Interface>(
  ldPath/"libSandboxPlugins", "toto_plugin1", boost::dll::load_mode::append_decorations);

  boost::shared_ptr<Plugins::Interface> plug2 = boost::dll::import<Plugins::Interface>(
      ldPath/"libSandboxPlugins", "toto_plugin2", boost::dll::load_mode::append_decorations);
