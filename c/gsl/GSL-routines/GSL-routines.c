...
double GSLdran(gsl_rng *r,double min,double max)
{
	if(max > 4294967295)
	{
		printf("/n max must be < 4294967295 in '%s' "
...
void GSLgauss_dist(double *tgaus,unsigned long int seed, int nbpts, double mean, double sigma)
{
/*----------------------------------------------------------------------
...
/*----------------------------------------------------------------------
----------------------------------------------------------------------*/
void GLSgauss_zig_dist(double *tgaus,unsigned long int seed, int nbpts, double mean, double sigma)
{
/*----------------------------------------------------------------------
...
void GSLbiv_gauss_dist(double *xtab,double *ytab,unsigned long int seed,
	int nbpts,double mean_x,double mean_y,double sigma_x,double sigma_y,double corr)
{
/*----------------------------------------------------------------------
