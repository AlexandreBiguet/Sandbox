...
#define MALLOC(_p, _t, _n)                                                    \
  do {                                                                        \
    ...
    if ((_p) == NULL) {                                                       \
      fprintf(stderr, "Allocation impossible dans le fichier :%s ligne : %s", \
              __FILE__, __LINE__);                                            \
      exit(EXIT_FAILURE);                                                     \
    }                                                                         \
  } while (0)
...
/* FIN :  TEST DE MACROS POUR CONSTRUIRE DES MATRICES : NE MARCHE PAS POUR LE
 * MOMENT */

/**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/ /**/
/**/                                                                     /**/

void matrix_char_set_str(char *in, size_t strlenght, size_t numero_ligne,
                         gsl_matrix_char *out) {
...
void plot_fcts_2(double (*f[])(double), size_t nbfct, size_t nbpts,
                 gsl_matrix_char *tit) {
  double xlo = 0.;
  double xhi = 5.;
  ...
  (size_t)1 ); fprintf(file,"!epstopdf plot.eps \n");
  fprintf(file,"!rm plot.eps \n");*/
